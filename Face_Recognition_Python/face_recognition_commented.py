...
face_cascade = cv2.CascadeClassifier('c:/Users/.../haarcascade_frontalface_default.xml') # We load the cascade for the face.
eye_cascade = cv2.CascadeClassifier('c:/Users/.../haarcascade_eye.xml') # We load the cascade for the eyes.
